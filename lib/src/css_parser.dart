    ...
    if (value.isNotEmpty) {
      switch (property) {
        ...
        case 'border':
          ...
          break;
        case 'border-radius':
          List<css.LiteralTerm?>? borderRadiuses = value.whereType<css.LiteralTerm>().toList();
          ...
          css.LiteralTerm? borderRadius = borderRadiuses.firstWhereOrNull((element) => element != null);

          BorderRadius newBorderRadius = BorderRadius.all(
            Radius.circular(ExpressionMapping.expressionToBorderRadius(borderRadius)),
          );
        ...
        case 'margin-left':
          style.margin =
              (style.margin ?? const Margins()).copyWith(left: ExpressionMapping.expressionToMargin(value.first));
          break;
        case 'margin-right':
          style.margin =
              (style.margin ?? const Margins()).copyWith(right: ExpressionMapping.expressionToMargin(value.first));
          break;
        case 'margin-top':
          style.margin =
              (style.margin ?? const Margins()).copyWith(top: ExpressionMapping.expressionToMargin(value.first));
          break;
        case 'margin-bottom':
          style.margin =
              (style.margin ?? const Margins()).copyWith(bottom: ExpressionMapping.expressionToMargin(value.first));
          break;
        case 'margin-inline':
          List<css.LiteralTerm>? marginLengths = value.whereType<css.LiteralTerm>().toList();
          ...
          marginLengths.removeWhere((element) =>
              ...
              element is! css.NumberTerm &&
              !(element.text == 'auto'));
          Margins margin = ExpressionMapping.expressionToInlineMargins(marginLengths);
          style.margin = (style.margin ?? const Margins()).copyWith(
        ...
        case 'margin-block':
          ...
          marginLengths.removeWhere((element) =>
              ...
              element is! css.NumberTerm &&
              !(element.text == 'auto'));
          Margins margin = ExpressionMapping.expressionToBlockMargins(marginLengths);
          style.margin = (style.margin ?? const Margins()).copyWith(
        ...
        case 'padding':
          ...
          paddingLengths.removeWhere((element) =>
              ...
              element is! css.RemTerm &&
              element is! css.NumberTerm);
          final padding = ExpressionMapping.expressionToHtmlPaddings(paddingLengths);
          ...
          break;
        case 'padding-left':
          style.padding = (style.padding ?? const HtmlPaddings())
              .copyWith(left: ExpressionMapping.expressionToHtmlPadding(value.first));
          break;
        case 'padding-right':
          style.padding = (style.padding ?? const HtmlPaddings())
              .copyWith(right: ExpressionMapping.expressionToHtmlPadding(value.first));
          break;
        case 'padding-top':
          style.padding = (style.padding ?? const HtmlPaddings())
              .copyWith(top: ExpressionMapping.expressionToHtmlPadding(value.first));
          break;
        case 'padding-bottom':
          style.padding = (style.padding ?? const HtmlPaddings())
              .copyWith(bottom: ExpressionMapping.expressionToHtmlPadding(value.first));
          break;
        case 'padding-inline':
          List<css.LiteralTerm>? paddingLengths = value.whereType<css.LiteralTerm>().toList();
          ...
          paddingLengths.removeWhere((element) =>
              ...
              element is! css.RemTerm &&
              element is! css.NumberTerm);
          HtmlPaddings padding = ExpressionMapping.expressionToInlineHtmlPadding(paddingLengths);
          style.padding = (style.padding ?? const HtmlPaddings()).copyWith(
        ...
        case 'padding-block':
          ...
          paddingLengths.removeWhere((element) =>
              ...
              element is! css.RemTerm &&
              element is! css.NumberTerm);
          HtmlPaddings padding = ExpressionMapping.expressionToBlockHtmlPadding(paddingLengths);
          style.padding = (style.padding ?? const HtmlPaddings()).copyWith(
        ...
        case 'text-transform':
          ...
          break;
        case 'vertical-align':
          style.verticalAlign = ExpressionMapping.expressionToVerticalAlign(value.first);
          break;
        case 'width':
...
class ExpressionMapping {
  ...
  static HtmlPaddings expressionToInlineHtmlPadding(List<css.Expression>? lengths) {
  ...
  static HtmlPaddings expressionToBlockHtmlPadding(List<css.Expression>? lengths) {
